...
TransferArgsKind = typing.Union[V1]
TransferArgsJSON = typing.Union[V1JSON]


def from_decoded(obj: dict) -> TransferArgsKind:
...
def from_json(obj: TransferArgsJSON) -> TransferArgsKind:
    if obj["kind"] == "V1":
