...
UnlockArgsKind = typing.Union[V1]
UnlockArgsJSON = typing.Union[V1JSON]


def from_decoded(obj: dict) -> UnlockArgsKind:
...
def from_json(obj: UnlockArgsJSON) -> UnlockArgsKind:
    if obj["kind"] == "V1":
